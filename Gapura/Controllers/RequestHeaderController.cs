...
namespace Gapura.Controllers
{
    public class RequestHeaderController : Controller
    {
        ...
        {
            return View(dbConn.RequestHeaders.ToList());
        }
        ...
        public ActionResult LoadData()
        {
            //using (YSIDGAEntitiesConn dc = new YSIDGAEntitiesConn())
            {
                ...
                var data = dbConn.SPR_RequestHeader().ToList();
        ...
        {
            var routeList = dbConn.Employees.Where(e => e.LastName.Contains(term))
                    .Take(6)
        ...
        public ActionResult Create()
        {
            ...
            int iSeq = dbConn.RequestHeaders.Count();
            string sSeq;
            ...
            if (iSeq == 0) {
                ...
                sSeq = (from rh in dbConn.RequestHeaders
            ...
            //                     };
            ViewBag.RequestTypeID = new SelectList(dbConn.MasterRequestTypes, "ID", "RequestType");
            ViewBag.CurrencyID = new SelectList(dbConn.MasterCurrencies, "ID", "CurrencyCode");
            ViewBag.AssetsTypeID = new SelectList(dbConn.MasterAssetsTypes, "ID", "AssetsType");
            ViewBag.EmployeeID = new SelectList(dbConn.Employees, "EmployeeID", "LastName");
            ViewBag.MgrID = new SelectList(dbConn.Employees, "EmployeeID", "LastName");
        ...
        public ActionResult Create(RequestHeader requestheader)
        {
            ...
            {
                dbConn.RequestHeaders.Add(requestheader);
                dbConn.SaveChanges();
                return RedirectToAction("Index");
            }
            ViewBag.DepartemenID = new SelectList(dbConn.Departements, "DepartemenID", "CompanyName", requestheader.DepartemenID);
            ...
            ViewBag.MgrID = new SelectList(dbConn.Employees, "EmployeeID", "LastName", requestheader.MgrID);
        ...
        public JsonResult Save(RequestHeader request)
        {
            ...
            if (isValidModel)
            {
                using (YSIDGAEntitiesConn reqConn = new YSIDGAEntitiesConn())
                {
                    reqConn.RequestHeaders.Add(request);
                    reqConn.SaveChanges();
                    status = true;
                    //return Json(new {
        ...
        {
            List<RequestDetail> reqDetail = dbConn.RequestDetails.ToList();
        ...
        public ActionResult Edit(int id = 0)
        {
            ...
            ViewBag.DepartemenID = new SelectList(dbConn.Departements, "DepartemenID", "DepartemenName", requestheader.DepartemenID);
            ViewBag.RequestTypeID = new SelectList(dbConn.MasterRequestTypes, "ID", "RequestType", requestheader.RequestTypeID);
            ViewBag.CurrencyID = new SelectList(dbConn.MasterCurrencies, "ID", "CurrencyCode", requestheader.CurrencyID);
            ViewBag.AssetsTypeID = new SelectList(dbConn.MasterAssetsTypes, "ID", "AssetsType", requestheader.AssetsTypeID);
            ViewBag.EmployeeID = new SelectList(dbConn.Employees, "EmployeeID", "LastName", requestheader.EmployeeID);
            ...
            ViewData["RequestDetails"] = dbConn.Database.SqlQuery<RequestDetailListVM>("EXEC SPR_RequestDetail {0}", id).ToList();
...
*/
        ...
        public ActionResult Edit(RequestHeader requestheader)
        {
            ...
            if (ModelState.IsValid)
            {
                dbConn.Entry(requestheader).State = EntityState.Modified;
                dbConn.SaveChanges();
                return RedirectToAction("Index");
            }
            ViewData["ReffNo"] = requestheader.ReffNo;
            ...
            ViewData["TotalRequest"] = requestheader.TotalRequest;
            ViewData["TotalPrice"] = requestheader.TotalPrice;
            //ViewBag.RequestDetails = requestheader.RequestDetails.ToList();
...
*/
        ...
        {
            RequestHeader requestheader = dbConn.RequestHeaders.Find(id);
            dbConn.RequestHeaders.Remove(requestheader);
            dbConn.SaveChanges();
            return RedirectToAction("Index");
        }
